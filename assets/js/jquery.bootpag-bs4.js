  ...
  $.fn.bootpag = function (options) {
    ...
    function renderPage($bootpag, page) {
      ...
      var lp,
        ...
        $page = $bootpag.find('li');
      settings.page = page =
        page < 0 ? 0 : page > settings.total ? settings.total : page;
      $page.removeClass(settings.activeClass);
      lp =
        page - 1 < 1
          ? 1
    ...
    return this.each(function () {
      ...
      if (settings.next) {
        lp =
          settings.leaps && settings.total > settings.maxVisible
      ...
      me.find('li').click(function paginationClick() {
        var me = $(this);
        if (
          me.hasClass(settings.disabledClass) ||
          me.hasClass(settings.activeClass)
        ) {
          return;
        }
